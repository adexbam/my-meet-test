...
const credentials = {
  ...
  redirect_uris: ["https://adexbam.github.io/my-meet-test/"],
  javascript_origins: ["https://adexbam.github.io", "http://localhost:3000"],
};
 ...
 *
 */
module.exports.getAuthenURL = async () => {
  /**
   *
...
module.exports.getTokenAccess = async (event) => {
